...
type Logger interface {
	...
	// Panic returns a LoggerContext for a panic log.
	Panic() LoggerContext

	// Trace returns a LoggerContext for a trace log.
	Trace() LoggerContext

	// WithLevel starts a new message with level.
	WithLevel(Level) LoggerContext
...
type LoggerContext interface {
	...
	// Send sends the LoggerContext with msg to the logger.
	Send()
